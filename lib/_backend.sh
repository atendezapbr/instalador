...
backend_redis_create() {
  print_banner
  printf "${green} 💻 Criando Redis & Banco Postgres...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_set_env() {
  print_banner
  printf "${green} 💻 Configurando variáveis de ambiente (backend)...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_node_build() {
  print_banner
  printf "${green} 💻 Compilando o código do backend...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_db_migrate() {
  print_banner
  printf "${green} 💻 Executando db:migrate...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_db_seed() {
  print_banner
  printf "${green} 💻 Executando db:seed...${GRAY_LIGHT}"
  printf "\n\n"
