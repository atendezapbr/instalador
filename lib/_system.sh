...
system_create_user() {
  print_banner
  printf "${green} 💻 Agora, vamos criar o usuário para a instancia...${GRAY_LIGHT}"
  printf "\n\n"
...
system_git_clone() {
  print_banner
  printf "${green} 💻 Fazendo download do código AtendeZap...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${green} 💻 Vamos atualizar o sistema AtendeZap...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${orange} 💻 Vamos deletar o AtendeZap...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${orange} 💻 Remoção da Instancia/Empresa ${empresa_delete} realizado com sucesso ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${red} 💻 Vamos bloquear o AtendeZap...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${red} 💻 Bloqueio da Instancia/Empresa ${empresa_bloquear} realizado com sucesso ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${red} 💻 Vamos Desbloquear o AtendeZap...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${green} 💻 Desbloqueio da Instancia/Empresa ${empresa_desbloquear} realizado com sucesso ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${green} 💻 Vamos Alterar os Dominios do AtendeZap...${GRAY_LIGHT}"
  printf "\n\n"
...
system_docker_install() {
  print_banner
  printf "${green} 💻 Instalando docker...${GRAY_LIGHT}"
  printf "\n\n"
